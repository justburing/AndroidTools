...
/**
 * 一个自定义的RadioGroup,支持复合布局，自动递归寻找radioButton
 */
public class RXRadioGroup extends LinearLayout {
    ...
    public RXRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new RXRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof RXRadioGroup.LayoutParams;
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(RXRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == RXRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == RXRadioGroup.this
